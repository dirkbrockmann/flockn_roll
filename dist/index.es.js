...
function hh(t) {
  ...
  for (var r = this._groups, i = r.length, o = [], a = [], s = 0; s < i; ++s)
    for (var l = r[s], u = l.length, c, h = 0; h < u; ++h)
      if (c = l[h]) {
        for (var f = t.call(c, c.__data__, h, l), p, g = Q(c, e), _ = 0, w = f.length; _ < w; ++_)
          (p = f[_]) && Ye(p, n, e, _, f, g);
        o.push(f), a.push(c);
      }
  return new ht(o, a, n, e);
}
var ph = Xn.prototype.constructor;
function dh() {
...
function mh(t, n, e) {
  ...
  return n == null ? this.styleTween(t, gh(t, r)).on("end.style." + t, ps(t)) : typeof n == "function" ? this.styleTween(t, yh(t, r, vi(this, "style." + t, n))).each(vh(this._id, t)) : this.styleTween(t, _h(t, r, n), e).on("end.style." + t, null);
}
function wh(t, n, e) {
  return function(r) {
...
function Ah(t) {
  return this.tween("text", typeof t == "function" ? $h(vi(this, "text", t)) : Mh(t == null ? "" : t + ""));
}
function Nh(t) {
  return function(n) {
...
Xn.prototype.interrupt = Of;
Xn.prototype.transition = Ih;
...
class Lh {
  ...
  arcTo(n, e, r, i, o) {
    ...
    if (this._x1 === null)
      ...
      let p = r - a, g = i - s, _ = l * l + u * u, w = p * p + g * g, b = Math.sqrt(_), d = Math.sqrt(f), x = o * Math.tan((Lr - Math.acos((_ + f - w) / (2 * b * d))) / 2), y = x / d, m = x / b;
      Math.abs(y - 1) > Nt && this._append`L${n + y * c},${e + y * h}`, this._append`A${o},${o},0,0,${+(h * p > c * g)},${this._x1 = n + m * l},${this._y1 = e + m * u}`;
    }
  }
  arc(n, e, r, i, o, a) {
...
function Uh(t) {
  var n = t.grouping === void 0 || t.thousands === void 0 ? vo : Dh(mo.call(t.grouping, Number), t.thousands + ""), e = t.currency === void 0 ? "" : t.currency[0] + "", r = t.currency === void 0 ? "" : t.currency[1] + "", i = t.decimal === void 0 ? "." : t.decimal + "", o = t.numerals === void 0 ? vo : qh(mo.call(t.numerals, String)), a = t.percent === void 0 ? "%" : t.percent + "", s = t.minus === void 0 ? "−" : t.minus + "", l = t.nan === void 0 ? "NaN" : t.nan + "";
  function u(h) {
    h = Ae(h);
    var f = h.fill, p = h.align, g = h.sign, _ = h.symbol, w = h.zero, b = h.width, d = h.comma, x = h.precision, y = h.trim, m = h.type;
    m === "n" ? (d = !0, m = "g") : yo[m] || (x === void 0 && (x = 12), y = !0, m = "g"), (w || f === "0" && p === "=") && (w = !0, f = "0", p = "=");
    var P = _ === "$" ? e : _ === "#" && /[boxX]/.test(m) ? "0" + m.toLowerCase() : "", E = _ === "$" ? r : /[%p]/.test(m) ? a : "", O = yo[m], B = /[defgprs%]/.test(m);
    ...
    function X(v) {
      ...
      if (m === "c")
        ...
        v = +v;
        var H = v < 0 || 1 / v < 0;
        if (v = isNaN(v) ? l : O(Math.abs(v), x), y && (v = Xh(v)), H && +v == 0 && g !== "+" && (H = !1), z = (H ? g === "(" ? g : s : g === "-" || g === "(" ? "" : g) + z, N = (m === "s" ? wo[8 + _s / 3] : "") + N + (H && g === "(" ? ")" : ""), B) {
      ...
      d && !w && (v = n(v, 1 / 0));
      var G = z.length + v.length + N.length, k = G < b ? new Array(b - G + 1).join(f) : "";
      switch (d && w && (v = n(k + v, k.length ? b - N.length : 1 / 0), k = ""), p) {
        case "<":
          v = z + v + N + k;
          break;
        case "=":
          ...
          break;
        case "^":
          v = k.slice(0, G = k.length >> 1) + z + v + N + k.slice(G);
          break;
        default:
          v = k + z + v + N;
          break;
  ...
  function c(h, f) {
    var p = u((h = Ae(h), h.type = "f", h)), g = Math.max(-8, Math.min(8, Math.floor(an(f) / 3))) * 3, _ = Math.pow(10, -g), w = wo[8 + g / 3];
    return function(b) {
      return p(_ * b) + w;
    };
  }
...
function rp() {
  var t = bo, n = bo, e = _i, r, i, o, a = Kt, s, l, u;
  function c() {
...
ge.prototype = wi.prototype = {
  ...
  on: function(t, n) {
    ...
    if (n != null && typeof n != "function") throw new Error("invalid callback: " + n);
    for (; ++o < a; )
      if (i = (t = r[o]).type) e[i] = xo(e[i], t.name, n);
      else if (n == null) for (i in e) e[i] = xo(e[i], t.name, null);
    return this;
  },
  copy: function() {
    var t = {}, n = this._;
...
function Zp(t, n) {
  ...
  for (var o = i.length, a = new Array(o), s = new Array(o), l = new Array(o), u = 0; u < o; ++u) {
    var c = r[u], h = i[u], f = h.length, p = Wp(t.call(c, c && c.__data__, u, r)), g = p.length, _ = s[u] = new Array(g), w = a[u] = new Array(g), b = l[u] = new Array(f);
    e(c, h, _, w, b, p, n);
    for (var d = 0, x = 0, y, m; d < g; ++d)
      if (y = _[d]) {
        for (d >= x && (x = d + 1); !(m = w[x]) && ++x < g; ) ;
...
function Ps(t, n) {
  for (var e = xi(t), r = -1, i = n.length; ++r < i; ) e.add(n[r]);
}
function Es(t, n) {
  for (var e = xi(t), r = -1, i = n.length; ++r < i; ) e.remove(n[r]);
}
function Ad(t) {
  return function() {
    Ps(this, t);
...
function Sd(t, n) {
  var e = Ts(t + "");
  if (arguments.length < 2) {
    for (var r = xi(this.node()), i = -1, o = e.length; ++i < o; ) if (!r.contains(e[i])) return !1;
    return !0;
  }
...
function Xd(t, n) {
  var e = typeof t == "function" ? t : bs(t), r = n == null ? Bd : typeof n == "function" ? n : bi(n);
  return this.select(function() {
    return this.insertBefore(e.apply(this, arguments), r.apply(this, arguments) || null);
  });
}
...
function d0() {
  var t = c0, n = f0, e = h0, r = p0, i = {}, o = wi("start", "drag", "end"), a = 0, s, l, u, c, h = 0;
  function f(y) {
    y.on("mousedown.drag", p).filter(r).on("touchstart.drag", w).on("touchmove.drag", b, s0).on("touchend.drag touchcancel.drag", d).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function p(y, m) {
    if (!(c || !t.call(this, y, m))) {
      var P = x(this, n.call(this, y, m), y, m, "mouse");
      P && (I(y.view).on("mousemove.drag", g, Cn).on("mouseup.drag", _, Cn), u0(y.view), vr(y), u = !1, s = y.clientX, l = y.clientY, P("start", y));
    }
  }
  function g(y) {
    if (Qt(y), !u) {
  ...
  function w(y, m) {
    if (t.call(this, y, m)) {
      var P = y.changedTouches, E = n.call(this, y, m), O = P.length, B, X;
      for (B = 0; B < O; ++B)
        (X = x(this, E, y, m, P[B].identifier, P[B])) && (vr(y), X("start", y, P[B]));
    }
  }
  function b(y) {
    var m = y.changedTouches, P = m.length, E, O;
    for (E = 0; E < P; ++E)
      (O = i[m[E].identifier]) && (Qt(y), O("drag", y, m[E]));
  }
  function d(y) {
    var m = y.changedTouches, P = m.length, E, O;
    for (c && clearTimeout(c), c = setTimeout(function() {
      ...
      (O = i[m[E].identifier]) && (vr(y), O("end", y, m[E]));
  }
  function x(y, m, P, E, O, B) {
    var X = o.copy(), v = $o(B || P, m), z, N, C;
    if ((C = e.call(y, new Xr("beforestart", {
      ...
      return z = C.x - v[0] || 0, N = C.y - v[1] || 0, function At(F, H, G) {
        var k = v, gr;
        switch (F) {
          case "start":
            i[O] = At, gr = a++;
...
function P0(t) {
  return (t = +t) == 1 ? Is : function(n, e) {
    return e - n ? S0(n, e, t) : $i(isNaN(n) ? e : n);
  };
}
function Is(t, n) {
  var e = n - t;
  return e ? T0(t, e) : $i(isNaN(t) ? n : t);
}
const Ee = function t(n) {
  var e = P0(n);
  function r(i, o) {
    var a = e((i = Hr(i)).r, (o = Hr(o)).r), s = e(i.g, o.g), l = e(i.b, o.b), u = Is(i.opacity, o.opacity);
    return function(c) {
      return i.r = a(c), i.g = s(c), i.b = l(c), i.opacity = u(c), i + "";
    };
  }
...
function Rs(t, n) {
  var e = Ur.lastIndex = wr.lastIndex = 0, r, i, o, a = -1, s = [], l = [];
...
function Ai(t, n) {
  var e = typeof n, r;
  return n == null || e === "boolean" ? $i(n) : (e === "number" ? K : e === "string" ? (r = Lt(n)) ? (n = r, Ee) : Rs : n instanceof Lt ? Ee : n instanceof Date ? z0 : k0(n) ? E0 : Array.isArray(n) ? O0 : typeof n.valueOf != "function" && typeof n.toString != "function" || isNaN(n) ? C0 : K)(t, n);
}
function j0(t, n) {
  return t = +t, n = +n, function(e) {
    return Math.round(t * (1 - e) + n * e);
...
ze.prototype = Bs.prototype = {
  ...
  restart: function(t, n, e) {
    if (typeof t != "function") throw new TypeError("callback is not a function");
    e = (e == null ? Ni() : +e) + (n == null ? 0 : +n), !this._next && An !== this && (An ? An._next = this : ke = this, An = this), this._call = t, this._time = e, Gr();
  },
  stop: function() {
...
function Gr(t) {
  if (!un) {
    $n && ($n = clearTimeout($n));
    var n = t - Ft;
    n > 24 ? (t < 1 / 0 && ($n = setTimeout(Co, t - jn.now() - Ke)), vn && (vn = clearInterval(vn))) : (vn || (Oe = jn.now(), vn = setInterval(H0, Ds)), un = 1, qs(Co));
  }
}
function Io(t, n, e) {
  var r = new ze();
...
var G0 = wi("start", "end", "cancel", "interrupt"), Y0 = [], Xs = 0, Ro = 1, Yr = 2, _e = 3, jo = 4, Vr = 5, ye = 6;
...
function Ti(t, n) {
  var e = tt(t, n);
  if (e.state > Xs) throw new Error("too late; already scheduled");
  return e;
}
function at(t, n) {
  var e = tt(t, n);
...
function K0(t, n) {
  ...
  if (e) {
    ...
    for (a in e) {
      ...
      i = r.state > Yr && r.state < Vr, r.state = ye, r.timer.stop(), r.on.call(i ? "interrupt" : "cancel", t, t.__data__, r.index, r.group), delete e[a];
    }
    o && delete t.__transition;
  }
}
...
function ag(t, n) {
  var e = Ve(t), r = e === "transform" ? q0 : Hs;
  return this.attrTween(t, typeof n == "function" ? (e.local ? og : ig)(e, r, Si(this, "attr." + t, n)) : n == null ? (e.local ? ng : tg)(e) : (e.local ? rg : eg)(e, r, n));
}
function sg(t, n) {
  return function(e) {
    this.setAttribute(t, n.call(this, e));
...
function Eg(t) {
  ...
  for (var r = this._groups, i = r.length, o = [], a = [], s = 0; s < i; ++s)
    for (var l = r[s], u = l.length, c, h = 0; h < u; ++h)
      if (c = l[h]) {
        for (var f = t.call(c, c.__data__, h, l), p, g = tt(c, e), _ = 0, w = f.length; _ < w; ++_)
          (p = f[_]) && Ze(p, n, e, _, f, g);
        o.push(f), a.push(c);
      }
...
function jg(t, n, e) {
  var r = (t += "") == "transform" ? D0 : Hs;
  return n == null ? this.styleTween(t, zg(t, r)).on("end.style." + t, Us(t)) : typeof n == "function" ? this.styleTween(t, Ig(t, r, Si(this, "style." + t, n))).each(Rg(this._id, t)) : this.styleTween(t, Cg(t, r, n), e).on("end.style." + t, null);
}
function Lg(t, n, e) {
  return function(r) {
    this.style.setProperty(t, n.call(this, r), e);
...
function Xg(t) {
  return this.tween("text", typeof t == "function" ? Bg(Si(this, "text", t)) : qg(t == null ? "" : t + ""));
}
function Hg(t) {
  return function(n) {
    this.textContent = t.call(this, n);
...
function Qg(t) {
  var n, e;
  t instanceof pt ? (n = t._id, t = t._name) : (n = Gs(), (e = Wg).time = Ni(), t = t == null ? null : t + "");
  for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
    for (var a = r[o], s = a.length, l, u = 0; u < s; ++u)
...
const Kr = Math.PI, Zr = 2 * Kr, Tt = 1e-6, t_ = Zr - Tt;
function Ys(t) {
  this._ += t[0];
  for (let n = 1, e = t.length; n < e; ++n)
    this._ += arguments[n] + t[n];
...
class Vs {
  ...
  arcTo(n, e, r, i, o) {
    ...
    if (this._x1 === null)
      ...
      let p = r - a, g = i - s, _ = l * l + u * u, w = p * p + g * g, b = Math.sqrt(_), d = Math.sqrt(f), x = o * Math.tan((Kr - Math.acos((_ + f - w) / (2 * b * d))) / 2), y = x / d, m = x / b;
      Math.abs(y - 1) > Tt && this._append`L${n + y * c},${e + y * h}`, this._append`A${o},${o},0,0,${+(h * p > c * g)},${this._x1 = n + m * l},${this._y1 = e + m * u}`;
    }
  }
  arc(n, e, r, i, o, a) {
    if (n = +n, e = +e, r = +r, a = !!a, r < 0) throw new Error(`negative radius: ${r}`);
    let s = r * Math.cos(i), l = r * Math.sin(i), u = n + s, c = e + l, h = 1 ^ a, f = a ? i - o : o - i;
    this._x1 === null ? this._append`M${u},${c}` : (Math.abs(this._x1 - u) > Tt || Math.abs(this._y1 - c) > Tt) && this._append`L${u},${c}`, r && (f < 0 && (f = f % Zr + Zr), f > t_ ? this._append`A${r},${r},0,1,${h},${n - s},${e - l}A${r},${r},0,1,${h},${this._x1 = u},${this._y1 = c}` : f > Tt && this._append`A${r},${r},0,${+(f >= Kr)},${h},${this._x1 = n + r * Math.cos(o)},${this._y1 = e + r * Math.sin(o)}`);
  }
  rect(n, e, r, i) {
    this._append`M${this._x0 = this._x1 = +n},${this._y0 = this._y1 = +e}h${r = +r}v${+i}h${-r}Z`;
  }
...
function u_(t) {
  ...
  function u(h) {
    h = Ie(h);
    var f = h.fill, p = h.align, g = h.sign, _ = h.symbol, w = h.zero, b = h.width, d = h.comma, x = h.precision, y = h.trim, m = h.type;
    m === "n" ? (d = !0, m = "g") : Fo[m] || (x === void 0 && (x = 12), y = !0, m = "g"), (w || f === "0" && p === "=") && (w = !0, f = "0", p = "=");
    var P = _ === "$" ? e : _ === "#" && /[boxX]/.test(m) ? "0" + m.toLowerCase() : "", E = _ === "$" ? r : /[%p]/.test(m) ? a : "", O = Fo[m], B = /[defgprs%]/.test(m);
    x = x === void 0 ? 6 : /[gprs]/.test(m) ? Math.max(1, Math.min(21, x)) : Math.max(0, Math.min(20, x));
    function X(v) {
      var z = P, N = E, C, At, F;
      if (m === "c")
        ...
        v = +v;
        var H = v < 0 || 1 / v < 0;
        if (v = isNaN(v) ? l : O(Math.abs(v), x), y && (v = a_(v)), H && +v == 0 && g !== "+" && (H = !1), z = (H ? g === "(" ? g : s : g === "-" || g === "(" ? "" : g) + z, N = (m === "s" ? Bo[8 + Ks / 3] : "") + N + (H && g === "(" ? ")" : ""), B) {
          for (C = -1, At = v.length; ++C < At; )
            if (F = v.charCodeAt(C), 48 > F || F > 57) {
              N = (F === 46 ? i + v.slice(C + 1) : v.slice(C)) + N, v = v.slice(0, C);
              break;
  ...
  function c(h, f) {
    var p = u((h = Ie(h), h.type = "f", h)), g = Math.max(-8, Math.min(8, Math.floor(ln(f) / 3))) * 3, _ = Math.pow(10, -g), w = Bo[8 + g / 3];
    return function(b) {
      return p(_ * b) + w;
    };
  }
...
function y_(t, n, e) {
  var r = t[0], i = t[1], o = n[0], a = n[1];
  return i < r ? (r = Wr(i, r), o = e(a, o)) : (r = Wr(r, i), o = e(o, a)), function(s) {
    return o(r(s));
  };
}
function v_(t, n, e) {
  var r = Math.min(t.length, n.length) - 1, i = new Array(r), o = new Array(r), a = -1;
  for (t[r] < t[0] && (t = t.slice().reverse(), n = n.slice().reverse()); ++a < r; )
    i[a] = Wr(t[a], t[a + 1]), o[a] = e(n[a], n[a + 1]);
  return function(s) {
    var l = vp(t, s, 1, r) - 1;
    return o[l](i[l](s));
  };
...
function w_() {
  var t = Xo, n = Xo, e = Ai, r, i, o, a = Zt, s, l, u;
  function c() {
    var f = Math.min(t.length, n.length);
...
var k_ = "[object Null]", O_ = "[object Undefined]", Ho = it ? it.toStringTag : void 0;
function dn(t) {
  return t == null ? t === void 0 ? O_ : k_ : Ho && Ho in Object(t) ? T_(t) : E_(t);
}
function fn(t) {
...
var X_ = 1 / 0, H_ = 17976931348623157e292;
function br(t) {
  if (!t)
    return t === 0 ? t : 0;
  if (t = B_(t), t === X_ || t === -1 / 0) {
    var n = t < 0 ? -1 : 1;
    return n * H_;
  }
  return t === t ? t : 0;
...
var Jr = gn(gt, "WeakMap"), uy = 9007199254740991, ly = /^(?:0|[1-9]\d*)$/;
function Ei(t, n) {
  var e = typeof t;
...
function fy(t, n, e) {
  if (!hn(e))
    return !1;
  var r = typeof n;
  return (r == "number" ? Qe(e) && Ei(n, e.length) : r == "string" && n in e) ? ki(e[n], t) : !1;
}
...
var eu = Object.prototype, _y = eu.hasOwnProperty, yy = eu.propertyIsEnumerable, zi = Ko(/* @__PURE__ */ function() {
  return arguments;
}()) ? Ko : function(t) {
...
var ru = typeof exports == "object" && exports && !exports.nodeType && exports, Zo = ru && typeof module == "object" && module && !module.nodeType && module, my = Zo && Zo.exports === ru, Wo = my ? gt.Buffer : void 0, wy = Wo ? Wo.isBuffer : void 0, Qr = wy || vy, by = "[object Arguments]", xy = "[object Array]", My = "[object Boolean]", $y = "[object Date]", Ay = "[object Error]", Ny = "[object Function]", Ty = "[object Map]", Sy = "[object Number]", Py = "[object Object]", Ey = "[object RegExp]", ky = "[object Set]", Oy = "[object String]", zy = "[object WeakMap]", Cy = "[object ArrayBuffer]", Iy = "[object DataView]", Ry = "[object Float32Array]", jy = "[object Float64Array]", Ly = "[object Int8Array]", Fy = "[object Int16Array]", Dy = "[object Int32Array]", qy = "[object Uint8Array]", By = "[object Uint8ClampedArray]", Xy = "[object Uint16Array]", Hy = "[object Uint32Array]", T = {};
T[Ry] = T[jy] = T[Ly] = T[Fy] = T[Dy] = T[qy] = T[By] = T[Xy] = T[Hy] = !0;
...
function Zy(t, n) {
  var e = J(t), r = !e && zi(t), i = !e && !r && Qr(t), o = !e && !r && !i && ou(t), a = e || r || i || o, s = a ? dy(t.length, String) : [], l = s.length;
  for (var u in t)
...
function Ri(t, n) {
  ...
  return e.cache = new (Ri.Cache || yt)(), e;
}
Ri.Cache = yt;
var Pv = 500;
function Ev(t) {
  var n = Ri(t, function(r) {
...
var ti = gn(gt, "DataView"), ni = gn(gt, "Promise"), ei = gn(gt, "Set"), ra = "[object Map]", Wv = "[object Object]", ia = "[object Promise]", oa = "[object Set]", aa = "[object WeakMap]", sa = "[object DataView]", Jv = Xt(ti), Qv = Xt(Fn), tm = Xt(ni), nm = Xt(ei), em = Xt(Jr), bt = dn;
(ti && bt(new ti(new ArrayBuffer(1))) != sa || Fn && bt(new Fn()) != ra || ni && bt(ni.resolve()) != ia || ei && bt(new ei()) != oa || Jr && bt(new Jr()) != aa) && (bt = function(t) {
  var n = dn(t), e = n == Wv ? t.constructor : void 0, r = e ? Xt(e) : "";
  if (r)
    switch (r) {
      case Jv:
        return sa;
...
function lu(t, n, e, r, i, o) {
  ...
  for (o.set(t, n), o.set(n, t); ++h < s; ) {
    ...
    if (p) {
      if (!am(n, function(b, d) {
        if (!sm(p, d) && (g === b || i(g, b, e, r, o)))
          return p.push(d);
      })) {
        f = !1;
        break;
...
function Pm(t, n, e, r, i, o) {
  ...
  for (var w = a; ++h < l; ) {
    ...
    var b = t[f], d = n[f];
    if (r)
      var x = a ? r(d, b, f, n, t, o) : r(b, d, f, t, n, o);
    if (!(x === void 0 ? b === d || i(b, d, e, r, o) : x)) {
      _ = !1;
      break;
    }
    w || (w = f == "constructor");
...
function Om(t, n, e, r, i, o) {
  ...
  if (!(e & Em)) {
    var p = c && ha.call(t, "__wrapped__"), g = h && ha.call(n, "__wrapped__");
    if (p || g) {
      var _ = p ? t.value() : t, w = g ? n.value() : n;
      return o || (o = new ct()), i(_, w, e, r, o);
    }
  }
  return f ? (o || (o = new ct()), Pm(t, n, e, r, i, o)) : !1;
}
function ji(t, n, e, r, i) {
  return t === n ? !0 : t == null || n == null || !fn(t) && !fn(n) ? t !== t && n !== n : Om(t, n, e, r, ji, i);
}
var zm = 1, Cm = 2;
function Im(t, n, e, r) {
  var i = e.length, o = i;
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var c = new ct(), h;
      if (!(h === void 0 ? ji(u, l, zm | Cm, r, c) : h))
        return !1;
    }
  }
  return !0;
...
function Fm(t, n, e) {
  ...
  return o || ++r != i ? o : (i = t == null ? 0 : t.length, !!i && Oi(i) && Ei(a, i) && (J(t) || zi(t)));
}
function Dm(t, n) {
...
var qm = 1, Bm = 2;
function Xm(t, n) {
  return Ii(t) && cu(n) ? fu(er(t), n) : function(e) {
    var r = Iv(e, t);
    return r === void 0 && r === n ? Dm(e, t) : ji(n, r, qm | Bm);
  };
}
function Hm(t) {
  return function(n) {
...
function Gm(t) {
  return Ii(t) ? Hm(er(t)) : Um(t);
}
function Ym(t) {
  return typeof t == "function" ? t : t == null ? U_ : typeof t == "object" ? J(t) ? Xm(t[0], t[1]) : jm(t) : Gm(t);
}
function Vm(t) {
...
const o1 = (t, n, e = 12, r = 12) => {
...
}, a1 = "_widget_9wct0_49", s1 = "_label_9wct0_69", u1 = "_lit_9wct0_74", l1 = "_button_9wct0_78", c1 = "_symbol_9wct0_78", f1 = "_radio_9wct0_79", h1 = "_radiobutton_9wct0_79", p1 = "_selected_9wct0_85", d1 = "_toggle_9wct0_86", g1 = "_slider_9wct0_95", _1 = "_track_9wct0_95", y1 = "_track_overlay_9wct0_100", v1 = "_handle_9wct0_108", M = {
  widget: a1,
  label: s1,
  lit: u1,
  button: l1,
  ...
  const t = "button";
  var n = Li(), e = 50, r = 0.3, i = "round", o = { x: 0, y: 0 }, a = null, s = "bottom", l = null, u = function(f) {
  }, c = ["play"], h = 0;
  return {
    type: t,
    id: function(f) {
    ...
    click: function() {
      h = (h + 1) % c.length, u(), I(this.parentNode).select("." + M.symbol).attr("d", ri(c[h])(r * e));
    },
    press: function(f) {
      h = (h + 1) % c.length, u(), f.select("#button_" + n).select("." + M.symbol).attr("d", ri(c[h])(r * e));
    }
  };
}, S1 = () => {
  const t = "slider", n = We(".3f");
  var e = Li(), r = 100, i = 8, o = 10, a = !1, s = { x: 0, y: 0 }, l = "top-left", u = 4, c = null, h = function(d) {
  }, f = function(d) {
  }, p = [0, 1], g = 0, _ = null, w = cn().domain(p).range([0, r]).clamp(!0);
  const b = function(d, x, y = p) {
    const m = d.select("#slider_" + e);
    w.domain(y), g = x, m.selectAll("." + M.handle).transition().attr("cx", w(x)), a && m.select("." + M.label).text(_ + " = " + n(g)), h(), f();
  };
  return {
    type: t,
    scale: w,
  ...
  const t = "toggle";
  var n = Li(), e = 10, r = { x: 0, y: 0 }, i = null, o = "top", a = null, s = function(u) {
  }, l = 0;
  return {
    type: t,
    id: function(u) {
    ...
    reset: function(u, c) {
      ...
      h.selectAll("." + M.handle).transition().attr("cx", l ? 2 * e : 0), h.classed(M.selected, l), s();
    }
  };
}, E1 = (t, n) => {
  ...
  }), a.append("path").attr("d", ri(t.actions()[t.value()])(t.symbolsize() * t.size())).attr("class", M.symbol), r) {
  ...
  s = I(l).attr("class", M.widget + " " + M.slider).attr("id", r).attr("transform", "translate(" + t.x() + "," + t.y() + ")"), a.domain(i()).range([0, o]).clamp(!0);
  const u = t.knob() > t.girth() ? t.knob() : t.girth() / 2, c = (b) => {
    ...
    const y = d.getBoundingClientRect(), m = x - y.left, P = d.width && d.width.baseVal ? d.width.baseVal.value : y.width, E = y.width ? P / y.width : 1;
    return m * E - u;
  };
  s.append("path").attr("d", hu(t.size(), t.girth())).attr("class", M.track), s.append("circle").attr("class", M.handle).attr("r", t.knob()).attr("cx", a(t.value())), s.append("rect").attr("width", t.size() + 2 * u).attr("height", 2 * u).attr("transform", "translate(" + -u + "," + -u + ")").attr("class", M.track_overlay).on("click", function(b) {
    const d = h(b, this);
    if (d == null) return;
    const x = Math.max(0, Math.min(t.size(), d));
    t.value(a.invert(x)), t.update(), t.update_end(), s.selectAll("." + M.handle).attr("cx", a(t.value())), t.show() && s.select("." + M.label).text(t.label() + " = " + e(t.value()));
  }).call(
    d0().on("drag", function(b) {
      const d = h(b, this);
      if (d == null) return;
      const x = Math.max(0, Math.min(t.size(), d));
      t.value(a.invert(x)), t.update(), s.selectAll("." + M.handle).attr("cx", a(t.value())), t.show() && s.select("." + M.label).text(t.label() + " = " + e(t.value()));
    }).on("end", function(b) {
      t.update_end();
    })
  );
  ...
  return t.fontsize ? p = t.labelposition().match(/bottom/i) != null ? te([t.girth() / 2, t.knob()]) + t.fontsize() / 2 + w : -te([t.girth() / 2, t.knob()]) - t.fontsize() / 2 - w : p = t.labelposition().match(/bottom/i) != null ? te([t.girth() / 2, t.knob()]) + 7 + w : -te([t.girth() / 2, t.knob()]) - 7 - w, f = t.labelposition().match(/right/i) != null ? t.size() : t.labelposition().match(/center/i) != null ? t.size() / 2 : 0, g = t.labelposition().match(/right/i) != null ? "end" : t.labelposition().match(/center/i) != null ? "middle" : "start", _ = t.labelposition().match(/bottom/i) != null ? "hanging" : "top", s.append("text").text(t.show() ? t.label() + " = " + e(t.value()) : t.label()).attr("class", M.label).style("text-anchor", g).style("alignment-baseline", _).style("font-size", t.fontsize()).style("opacity", 1).attr("transform", "translate(" + f + "," + p + ")"), l;
}, O1 = (t, n) => {
  ...
  if (s.append("path").attr("d", hu(2 * t.size(), 2 * t.size())).attr("class", M.track), s.append("circle").attr("class", M.handle).attr("r", r).attr("cx", t.value() ? 2 * r : 0), s.append("rect").attr("width", 4 * t.size()).attr("height", 2 * t.size()).attr("class", M.track_overlay).attr("transform", "translate(" + -t.size() + "," + -t.size() + ")").on("click", t.click), i) {
    const l = Fi(4 * t.size(), 2 * t.size(), o);
  ...
  const g = Fi(t.buttonsize(), t.buttonsize(), r);
...
}, C1 = "_displayPanel_bnmb5_2", I1 = "_controlPanel_bnmb5_9", R1 = "_attract_scope_bnmb5_27", j1 = "_orient_scope_bnmb5_33", L1 = "_repell_scope_bnmb5_39", F1 = "_speed_bnmb5_45", D1 = "_drop_bnmb5_51", q1 = "_agent_bnmb5_57", j = {
  displayPanel: C1,
  controlPanel: I1,
  attract_scope: R1,
  orient_scope: j1,
...
var pu = typeof global == "object" && global && global.Object === Object && global, X1 = typeof self == "object" && self && self.Object === Object && self, vt = pu || X1 || Function("return this")(), $t = vt.Symbol, du = Object.prototype, H1 = du.hasOwnProperty, U1 = du.toString, wn = $t ? $t.toStringTag : void 0;
function G1(t) {
  var n = H1.call(t, wn), e = t[wn];
  try {
    t[wn] = void 0;
    var r = !0;
  } catch {
...
var Z1 = "[object Null]", W1 = "[object Undefined]", da = $t ? $t.toStringTag : void 0;
function Ht(t) {
  return t == null ? t === void 0 ? W1 : Z1 : da && da in Object(t) ? G1(t) : K1(t);
}
function qt(t) {
  return t != null && typeof t == "object";
}
...
function rr(t) {
  return typeof t == "symbol" || qt(t) && Ht(t) == J1;
}
function ir(t, n) {
  for (var e = -1, r = t == null ? 0 : t.length, i = Array(r); ++e < r; )
    i[e] = n(t[e], e, t);
...
var Q1 = /\s/;
function tw(t) {
  for (var n = t.length; n-- && Q1.test(t.charAt(n)); )
    ;
  return n;
}
var nw = /^\s+/;
function ew(t) {
  return t && t.slice(0, tw(t) + 1).replace(nw, "");
}
function dt(t) {
  var n = typeof t;
  return t != null && (n == "object" || n == "function");
}
var ya = NaN, rw = /^[-+]0x[0-9a-f]+$/i, iw = /^0b[01]+$/i, ow = /^0o[0-7]+$/i, aw = parseInt;
function sw(t) {
  if (typeof t == "number")
    return t;
  if (rr(t))
  ...
  t = ew(t);
  var e = iw.test(t);
  return e || ow.test(t) ? aw(t.slice(2), e ? 2 : 8) : rw.test(t) ? ya : +t;
}
var uw = 1 / 0, lw = 17976931348623157e292;
function Nr(t) {
  if (!t)
    return t === 0 ? t : 0;
  if (t = sw(t), t === uw || t === -1 / 0) {
    var n = t < 0 ? -1 : 1;
    return n * lw;
  }
  return t === t ? t : 0;
...
var cw = "[object AsyncFunction]", fw = "[object Function]", hw = "[object GeneratorFunction]", pw = "[object Proxy]";
function yu(t) {
  if (!dt(t))
    return !1;
  var n = Ht(t);
  return n == fw || n == hw || n == cw || n == pw;
}
...
var gw = Function.prototype, _w = gw.toString;
function Ut(t) {
  if (t != null) {
    try {
      return _w.call(t);
...
var yw = /[\\^$.*+?()[\]{}|]/g, vw = /^\[object .+?Constructor\]$/, mw = Function.prototype, ww = Object.prototype, bw = mw.toString, xw = ww.hasOwnProperty, Mw = RegExp(
  "^" + bw.call(xw).replace(yw, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function $w(t) {
  if (!dt(t) || dw(t))
    return !1;
...
var ii = Gt(vt, "WeakMap"), ma = function() {
  try {
...
var Tw = 9007199254740991, Sw = /^(?:0|[1-9]\d*)$/;
function or(t, n) {
  var e = typeof t;
  return n = n ?? Tw, !!n && (e == "number" || e != "symbol" && Sw.test(t)) && t > -1 && t % 1 == 0 && t < n;
}
function Pw(t, n, e) {
...
var Ew = Object.prototype, kw = Ew.hasOwnProperty;
function Ow(t, n, e) {
  var r = t[n];
  (!(kw.call(t, n) && ar(r, e)) || e === void 0 && !(n in t)) && Pw(t, n, e);
}
...
function Yn(t) {
  return t != null && qi(t.length) && !yu(t);
}
function Cw(t, n, e) {
  if (!dt(e))
    return !1;
...
function vu(t) {
  var n = t && t.constructor, e = typeof n == "function" && n.prototype || Iw;
  return t === e;
}
function Rw(t, n) {
  for (var e = -1, r = Array(t); ++e < t; )
...
var jw = "[object Arguments]";
function wa(t) {
  return qt(t) && Ht(t) == jw;
}
var mu = Object.prototype, Lw = mu.hasOwnProperty, Fw = mu.propertyIsEnumerable, wu = wa(/* @__PURE__ */ function() {
  return arguments;
}()) ? wa : function(t) {
  return qt(t) && Lw.call(t, "callee") && !Fw.call(t, "callee");
};
function Dw() {
  return !1;
}
var bu = typeof exports == "object" && exports && !exports.nodeType && exports, ba = bu && typeof module == "object" && module && !module.nodeType && module, qw = ba && ba.exports === bu, xa = qw ? vt.Buffer : void 0, Bw = xa ? xa.isBuffer : void 0, oi = Bw || Dw, Xw = "[object Arguments]", Hw = "[object Array]", Uw = "[object Boolean]", Gw = "[object Date]", Yw = "[object Error]", Vw = "[object Function]", Kw = "[object Map]", Zw = "[object Number]", Ww = "[object Object]", Jw = "[object RegExp]", Qw = "[object Set]", tb = "[object String]", nb = "[object WeakMap]", eb = "[object ArrayBuffer]", rb = "[object DataView]", ib = "[object Float32Array]", ob = "[object Float64Array]", ab = "[object Int8Array]", sb = "[object Int16Array]", ub = "[object Int32Array]", lb = "[object Uint8Array]", cb = "[object Uint8ClampedArray]", fb = "[object Uint16Array]", hb = "[object Uint32Array]", S = {};
S[ib] = S[ob] = S[ab] = S[sb] = S[ub] = S[lb] = S[cb] = S[fb] = S[hb] = !0;
S[Xw] = S[Hw] = S[eb] = S[Uw] = S[rb] = S[Gw] = S[Yw] = S[Vw] = S[Kw] = S[Zw] = S[Ww] = S[Jw] = S[Qw] = S[tb] = S[nb] = !1;
function pb(t) {
  return qt(t) && qi(t.length) && !!S[Ht(t)];
}
function db(t) {
  return function(n) {
    return t(n);
...
var xu = typeof exports == "object" && exports && !exports.nodeType && exports, Sn = xu && typeof module == "object" && module && !module.nodeType && module, gb = Sn && Sn.exports === xu, Sr = gb && pu.process, Ma = function() {
  try {
    var t = Sn && Sn.require && Sn.require("util").types;
    return t || Sr && Sr.binding && Sr.binding("util");
  } catch {
  }
}(), $a = Ma && Ma.isTypedArray, Mu = $a ? db($a) : pb, _b = Object.prototype, yb = _b.hasOwnProperty;
function $u(t, n) {
  var e = U(t), r = !e && wu(t), i = !e && !r && oi(t), o = !e && !r && !i && Mu(t), a = e || r || i || o, s = a ? Rw(t.length, String) : [], l = s.length;
  for (var u in t)
    (n || yb.call(t, u)) && !(a && // Safari 9 has enumerable `arguments.length` in strict mode.
    (u == "length" || // Node.js 0.10 has enumerable non-index properties on buffers.
    i && (u == "offset" || u == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
    o && (u == "buffer" || u == "byteLength" || u == "byteOffset") || // Skip index properties.
    or(u, l))) && s.push(u);
...
var vb = Au(Object.keys, Object), mb = Object.prototype, wb = mb.hasOwnProperty;
function bb(t) {
  if (!vu(t))
    return vb(t);
  var n = [];
  for (var e in Object(t))
    wb.call(t, e) && e != "constructor" && n.push(e);
  return n;
}
function sr(t) {
  return Yn(t) ? $u(t) : bb(t);
}
function xb(t) {
  var n = [];
  if (t != null)
...
var Mb = Object.prototype, $b = Mb.hasOwnProperty;
function Ab(t) {
  if (!dt(t))
    return xb(t);
  var n = vu(t), e = [];
...
function Bi(t, n) {
  if (U(t))
    return !1;
  var e = typeof t;
  return e == "number" || e == "symbol" || e == "boolean" || t == null || rr(t) ? !0 : Sb.test(t) || !Tb.test(t) || n != null && t in Object(n);
}
...
var kb = "__lodash_hash_undefined__", Ob = Object.prototype, zb = Ob.hasOwnProperty;
function Cb(t) {
  var n = this.__data__;
  if (Dn) {
    var e = n[t];
    return e === kb ? void 0 : e;
  }
  return zb.call(n, t) ? n[t] : void 0;
}
var Ib = Object.prototype, Rb = Ib.hasOwnProperty;
function jb(t) {
  var n = this.__data__;
  return Dn ? n[t] !== void 0 : Rb.call(n, t);
}
var Lb = "__lodash_hash_undefined__";
function Fb(t, n) {
  var e = this.__data__;
  return this.size += this.has(t) ? 0 : 1, e[t] = Dn && n === void 0 ? Lb : n, this;
}
function Bt(t) {
  var n = -1, e = t == null ? 0 : t.length;
  for (this.clear(); ++n < e; ) {
...
Bt.prototype.clear = Pb;
Bt.prototype.delete = Eb;
Bt.prototype.get = Cb;
Bt.prototype.has = jb;
Bt.prototype.set = Fb;
function Db() {
...
var qb = Array.prototype, Bb = qb.splice;
function Xb(t) {
  var n = this.__data__, e = ur(n, t);
  if (e < 0)
    return !1;
  var r = n.length - 1;
  return e == r ? n.pop() : Bb.call(n, e, 1), --this.size, !0;
}
function Hb(t) {
  var n = this.__data__, e = ur(n, t);
  return e < 0 ? void 0 : n[e][1];
...
mt.prototype.clear = Db;
mt.prototype.delete = Xb;
mt.prototype.get = Hb;
mt.prototype.has = Ub;
mt.prototype.set = Gb;
var qn = Gt(vt, "Map");
...
function lr(t, n) {
  var e = t.__data__;
  return Vb(n) ? e[typeof n == "string" ? "string" : "hash"] : e.map;
}
function Kb(t) {
...
wt.prototype.clear = Yb;
wt.prototype.delete = Kb;
wt.prototype.get = Zb;
wt.prototype.has = Wb;
wt.prototype.set = Jb;
...
function nx(t) {
  var n = Xi(t, function(r) {
    return e.size === tx && e.clear(), r;
  }), e = n.cache;
  return n;
}
var ex = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, rx = /\\(\\)?/g, ix = nx(function(t) {
  var n = [];
  return t.charCodeAt(0) === 46 && n.push(""), t.replace(ex, function(e, r, i, o) {
    n.push(i ? o.replace(rx, "$1") : r || e);
  }), n;
});
function cr(t) {
  return t == null ? "" : gu(t);
...
var ax = Au(Object.getPrototypeOf, Object);
function sx(t, n, e) {
  var r = -1, i = t.length;
...
function ux(t, n, e) {
  var r = t.length;
  return e = e === void 0 ? r : e, sx(t, n, e);
}
var lx = "\\ud800-\\udfff", cx = "\\u0300-\\u036f", fx = "\\ufe20-\\ufe2f", hx = "\\u20d0-\\u20ff", px = cx + fx + hx, dx = "\\ufe0e\\ufe0f", gx = "\\u200d", _x = RegExp("[" + gx + lx + px + dx + "]");
function Tu(t) {
  return _x.test(t);
}
function yx(t) {
...
var Su = "\\ud800-\\udfff", vx = "\\u0300-\\u036f", mx = "\\ufe20-\\ufe2f", wx = "\\u20d0-\\u20ff", bx = vx + mx + wx, xx = "\\ufe0e\\ufe0f", Mx = "[" + Su + "]", ai = "[" + bx + "]", si = "\\ud83c[\\udffb-\\udfff]", $x = "(?:" + ai + "|" + si + ")", Pu = "[^" + Su + "]", Eu = "(?:\\ud83c[\\udde6-\\uddff]){2}", ku = "[\\ud800-\\udbff][\\udc00-\\udfff]", Ax = "\\u200d", Ou = $x + "?", zu = "[" + xx + "]?", Nx = "(?:" + Ax + "(?:" + [Pu, Eu, ku].join("|") + ")" + zu + Ou + ")*", Tx = zu + Ou + Nx, Sx = "(?:" + [Pu + ai + "?", ai, Eu, ku, Mx].join("|") + ")", Px = RegExp(si + "(?=" + si + ")|" + Sx + Tx, "g");
function Ex(t) {
  return t.match(Px) || [];
}
function kx(t) {
  return Tu(t) ? Ex(t) : yx(t);
}
function Ox(t) {
  return function(n) {
    n = cr(n);
    var e = Tu(n) ? kx(n) : void 0, r = e ? e[0] : n.charAt(0), i = e ? ux(e, 1).join("") : n.slice(1);
    return r[t]() + i;
  };
}
var zx = Ox("toUpperCase");
function Cx(t) {
  return zx(cr(t).toLowerCase());
}
function Ix() {
...
ft.prototype.clear = Ix;
ft.prototype.delete = Rx;
ft.prototype.get = jx;
ft.prototype.has = Lx;
ft.prototype.set = Dx;
function Cu(t, n) {
...
var qx = Object.prototype, Bx = qx.propertyIsEnumerable, Aa = Object.getOwnPropertySymbols, Ru = Aa ? function(t) {
  return t == null ? [] : (t = Object(t), Cu(Aa(t), function(n) {
    return Bx.call(t, n);
  }));
} : Iu, Xx = Object.getOwnPropertySymbols, Hx = Xx ? function(t) {
  for (var n = []; t; )
    Nu(n, Ru(t)), t = ax(t);
  return n;
} : Iu;
...
var ui = Gt(vt, "DataView"), li = Gt(vt, "Promise"), ci = Gt(vt, "Set"), Ta = "[object Map]", Gx = "[object Object]", Sa = "[object Promise]", Pa = "[object Set]", Ea = "[object WeakMap]", ka = "[object DataView]", Yx = Ut(ui), Vx = Ut(qn), Kx = Ut(li), Zx = Ut(ci), Wx = Ut(ii), lt = Ht;
(ui && lt(new ui(new ArrayBuffer(1))) != ka || qn && lt(new qn()) != Ta || li && lt(li.resolve()) != Sa || ci && lt(new ci()) != Pa || ii && lt(new ii()) != Ea) && (lt = function(t) {
  var n = Ht(t), e = n == Gx ? t.constructor : void 0, r = e ? Ut(e) : "";
  if (r)
    switch (r) {
      case Yx:
        return ka;
...
var Oa = vt.Uint8Array, Jx = "__lodash_hash_undefined__";
function Qx(t) {
  return this.__data__.set(t, Jx), this;
}
function t2(t) {
  return this.__data__.has(t);
}
...
je.prototype.add = je.prototype.push = Qx;
je.prototype.has = t2;
function n2(t, n) {
  for (var e = -1, r = t == null ? 0 : t.length; ++e < r; )
    if (n(t[e], e, t))
...
var r2 = 1, i2 = 2;
function Lu(t, n, e, r, i, o) {
  var a = e & r2, s = t.length, l = n.length;
  if (s != l && !(a && l > s))
    return !1;
  var u = o.get(t), c = o.get(n);
  if (u && c)
    return u == n && c == t;
  var h = -1, f = !0, p = e & i2 ? new je() : void 0;
  for (o.set(t, n), o.set(n, t); ++h < s; ) {
    var g = t[h], _ = n[h];
    if (r)
      var w = a ? r(_, g, h, n, t, o) : r(g, _, h, t, n, o);
    ...
    if (p) {
      if (!n2(n, function(b, d) {
        if (!e2(p, d) && (g === b || i(g, b, e, r, o)))
          return p.push(d);
      })) {
        f = !1;
        break;
...
var a2 = 1, s2 = 2, u2 = "[object Boolean]", l2 = "[object Date]", c2 = "[object Error]", f2 = "[object Map]", h2 = "[object Number]", p2 = "[object RegExp]", d2 = "[object Set]", g2 = "[object String]", _2 = "[object Symbol]", y2 = "[object ArrayBuffer]", v2 = "[object DataView]", za = $t ? $t.prototype : void 0, Pr = za ? za.valueOf : void 0;
function m2(t, n, e, r, i, o, a) {
  switch (e) {
    case v2:
      if (t.byteLength != n.byteLength || t.byteOffset != n.byteOffset)
        return !1;
...
var w2 = 1, b2 = Object.prototype, x2 = b2.hasOwnProperty;
function M2(t, n, e, r, i, o) {
  var a = e & w2, s = Na(t), l = s.length, u = Na(n), c = u.length;
  if (l != c && !a)
    return !1;
  for (var h = l; h--; ) {
    var f = s[h];
    if (!(a ? f in n : x2.call(n, f)))
      return !1;
  }
  var p = o.get(t), g = o.get(n);
  if (p && g)
...
var $2 = 1, Ca = "[object Arguments]", Ia = "[object Array]", se = "[object Object]", A2 = Object.prototype, Ra = A2.hasOwnProperty;
function N2(t, n, e, r, i, o) {
  ...
  if (f && !c)
    return o || (o = new ft()), a || Mu(t) ? Lu(t, n, e, r, i, o) : m2(t, n, l, e, r, i, o);
  if (!(e & $2)) {
    var p = c && Ra.call(t, "__wrapped__"), g = h && Ra.call(n, "__wrapped__");
    if (p || g) {
      var _ = p ? t.value() : t, w = g ? n.value() : n;
      return o || (o = new ft()), i(_, w, e, r, o);
    }
  }
  return f ? (o || (o = new ft()), M2(t, n, e, r, i, o)) : !1;
}
function Ui(t, n, e, r, i) {
  return t === n ? !0 : t == null || n == null || !qt(t) && !qt(n) ? t !== t && n !== n : N2(t, n, e, r, Ui, i);
}
var T2 = 1, S2 = 2;
function P2(t, n, e, r) {
  var i = e.length, o = i;
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var c = new ft(), h;
      if (!(h === void 0 ? Ui(u, l, T2 | S2, r, c) : h))
        return !1;
    }
  }
  return !0;
...
function Bu(t, n, e) {
  ...
  return o || ++r != i ? o : (i = t == null ? 0 : t.length, !!i && qi(i) && or(a, i) && (U(t) || wu(t)));
}
function z2(t, n) {
  return t != null && Bu(t, n, O2);
}
var C2 = 1, I2 = 2;
function R2(t, n) {
  return Bi(t) && Du(n) ? qu(Vn(t), n) : function(e) {
    var r = ox(e, t);
    return r === void 0 && r === n ? z2(e, t) : Ui(n, r, C2 | I2);
  };
}
function j2(t) {
  return function(n) {
...
function F2(t) {
  return Bi(t) ? j2(Vn(t)) : L2(t);
}
function hr(t) {
  return typeof t == "function" ? t : t == null ? _u : typeof t == "object" ? U(t) ? R2(t[0], t[1]) : k2(t) : F2(t);
}
function D2(t) {
  return function(n, e, r) {
    for (var i = -1, o = Object(n), a = r(n), s = a.length; s--; ) {
...
var Y2 = "[object Map]", V2 = "[object Set]";
function K2(t) {
  return function(n) {
    var e = lt(n);
    return e == Y2 ? Fu(n) : e == V2 ? G2(n) : U2(n, t(n));
  };
}
var Xu = K2(sr);
function Z2(t, n) {
...
var J2 = Object.prototype, Q2 = J2.hasOwnProperty;
function tM(t, n) {
  return t != null && Q2.call(t, n);
}
function Hu(t, n) {
  return t != null && Bu(t, n, tM);
}
var nM = "[object Boolean]";
function eM(t) {
  return t === !0 || t === !1 || qt(t) && Ht(t) == nM;
}
function rM(t, n) {
...
function Uu(t, n) {
  if (t == null)
    return {};
  var e = ir(Ux(t), function(r) {
    return [r];
  });
  return n = hr(n), sM(t, e, function(r, i) {
    return n(r, i[0]);
  });
}
var uM = Math.ceil, lM = Math.max;
function cM(t, n, e, r) {
  for (var i = -1, o = lM(uM((n - t) / (e || 1)), 0), a = Array(o); o--; )
    a[++i] = t, t += e;
  return a;
}
function fM(t) {
  return function(n, e, r) {
    return r && typeof r != "number" && Cw(n, e, r) && (e = r = void 0), n = Nr(n), e === void 0 ? (e = n, n = 0) : e = Nr(e), r = r === void 0 ? n < e ? 1 : -1 : Nr(r), cM(n, e, r);
  };
}
var Yi = fM();
function hM() {
...
const A = {
  ...
  Xu(t),
  (n) => {
    n[1].id = n[0], Hu(n[1], "label") || (n[1].label = hM(Cx(n[0]), /_/g, " "));
  }
), Yu = (t) => _n(Xu(t), (n) => n[1]), Vu = (t, n) => Ct(t, (e, r) => e.widget = n[r]), pM = (t) => Uu(t, (n) => Hu(n, "range")), dM = (t) => Uu(t, (n) => eM(n.default)), Y = Hn().domain([0, 360]).range([0, 2 * Math.PI]), le = Hn().range([0, 360]).domain([0, 2 * Math.PI]), gM = (t, n) => {
  const e = t.x - n.x, r = t.y - n.y;
  return Math.sqrt(e * e + r * r);
}, Ku = (t) => {
  const e = pp().x((i) => t * i.x).y((i) => t * i.y), r = _n(Yi(30), (i) => ({
...
Vu(Wu, Bn);
Vu(Zu, Pn);
const xt = Di().actions(["play", "pause"]), pr = Di().actions(["back"]), dr = Di().actions(["rewind"]), _M = [xt, pr, dr];
...
const yM = (t, n) => {
  ...
  const i = n.position(A.widgets.slider_anchor.x, Yi(Pn.length).map((a) => A.widgets.slider_anchor.y + A.widgets.slider_gap * a)), o = n.position(A.widgets.toggle_anchor.x, A.widgets.toggle_anchor.y);
  Pn.forEach((a, s) => a.position(i[s])), Bn[0].position(o).labelposition(A.widgets.toggle_label_pos), xt.position(n.position(A.widgets.playbutton_anchor.x, A.widgets.playbutton_anchor.y)).size(A.widgets.playbutton_size), dr.position(n.position(A.widgets.backbutton_anchor.x, A.widgets.backbutton_anchor.y)), pr.position(n.position(A.widgets.resetbutton_anchor.x, A.widgets.resetbutton_anchor.y)), t.selectAll(null).data(Pn).enter().append(Ar), t.selectAll(null).data(Bn).enter().append(Ar), t.selectAll(null).data(_M).enter().append(Ar);
}, vM = (t) => {
  Ct(Vi, (n) => n.widget.reset(t, n.default)), Ct(Ki, (n) => n.widget.reset(t, n.default));
}, Le = $.L, ja = $.dt, mM = $.N;
var St = [];
const wM = () => {
  $.timer = {}, $.tick = 0, St = _n(Yi(mM), (t) => ({
    id: t,
    x: Math.random() * Le,
    y: Math.random() * Le,
  ...
  Ct(St, (n) => {
    let e = [];
    var r, i, o, a;
    if (e = ue(St, (u) => gM(n, u) < $.collision_radius.widget.value() && u.id != n.id), e.length > 0)
      r = n.x - Vt(e, (u) => u.x), i = n.y - Vt(e, (u) => u.y);
    else {
      const u = Math.cos(Y(n.theta)), c = Math.sin(Y(n.theta)), h = Math.sqrt(u * u + c * c), f = ue(St, (_) => {
        let w = _.x - n.x, b = _.y - n.y;
        _.r = Math.sqrt(w * w + b * b);
        let d = (w * u + b * c) / (h * _.r);
        return _.r < $.attraction_radius.widget.value() && d > t && _.id != n.id;
      }), p = ue(f, (_) => _.r < $.alignment_radius.widget.value()), g = ue(f, (_) => _.r > $.alignment_radius.widget.value());
      if (o = n.theta, a = n.theta, p.length > 0) {
        const _ = Vt(p, (b) => Math.cos(Y(b.theta))), w = Vt(p, (b) => Math.sin(Y(b.theta)));
        o = le(Math.atan2(w, _));
      }
      if (g.length > 0) {
        const _ = Vt(g, (b) => b.x), w = Vt(g, (b) => b.y);
        a = le(Math.atan2(w - n.y, _ - n.x));
      }
...
}, Ju = $.L, Fe = Hn().domain([0, Ju]), De = Hn().domain([0, Ju]);
function Zi(t) {
  return $.orli_switch.widget.value() ? sp(t.theta / 360) : null;
}
const xM = (t, n) => {
  const e = n.display_size.width, r = n.display_size.height;
  Fe.range([0, e]), De.range([0, r]), t.select("#origin").remove(), t.append("g").attr("id", "origin").selectAll("." + j.agent).data(St).enter().append("g").attr("class", j.agent).attr("transform", (a) => "translate(" + Fe(a.x) + "," + De(a.y) + ")rotate(" + a.theta + ")").style("fill", Zi).append("path").attr("d", Ku($.agentsize));
}, MM = (t, n) => {
  t.selectAll("." + j.agent).attr("transform", (e) => "translate(" + Fe(e.x) + "," + De(e.y) + ")rotate(" + e.theta + ")").style("fill", Zi);
}, $M = (t, n) => {
  t.selectAll("." + j.agent).attr("transform", (e) => "translate(" + Fe(e.x) + "," + De(e.y) + ")rotate(" + e.theta + ")").style("fill", Zi);
};
function AM(t, n) {
...
var La = {};
const TM = (t, n) => {
  xt.value() == 1 ? La = Tf(() => AM(t), A.simulation.delay) : La.stop();
}, SM = (t) => {
  ...
  dr.update(() => vM(n)), xt.update(() => TM(t)), pr.update(() => Qu(t, e)), Ct(Pn, (r) => {
    r.update(() => SM(n));
  }), Bn[0].update(() => NM(t));
}, EM = {
